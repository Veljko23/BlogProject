  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <li class="nav-item dropdown">
        <a class="nav-link"  href="message-list">
          ...
          <span class="badge badge-danger navbar-badge">${messagenCount }</span>
        </a>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form:form role="form" action="category-save" modelAttribute="category" enctype="multipart/form-data" method="POST">
              <form:hidden path="id"/>
                <div class="card-body">
...
<!--                   </div> -->
					<div class="form-group">
                        ...
                        <input name="file" value="image" type="file" class="form-control" id="image"/>
                    </div>
                </div>
                <!-- /.card-body -->
