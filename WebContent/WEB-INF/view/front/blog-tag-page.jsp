...
<%--               <c:if test="${fn:length(postList) > 0}"> --%>
              <div class="post col-xl-6">
                ...
                <div class="post-details">
                  ...
                  <p class="text-muted">${fn:substring(postList[i].text,0,200)}...</p>
              ...
              <c:if test="${postList.size() == 0 }">
              	<h2 class="mb-3">Not news for this tag</h2>
              </c:if>
            </div>
            <!-- Pagination -->
          <c:if test="${postList.size() > 0 }">
          ...
          <div class="widget tags">       
            ...
            <div>
              <c:forEach var="tag" items="${tagList }">
				<div class="item d-flex justify-content-between"><a href="blog-tag-page?id=${tag.id }&title=${tag.name}">${tag.name }</a><span>${tag.posts.size() }</span></div>             	
              </c:forEach>
            </div>
          </div>
        </aside>
    ...
    <footer class="main-footer">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
           <c:forEach var="lastPost" items="${lastThreePost }">
            <div class="latest-posts"><a href="blog-post-page?id=${lastPost.id}">
