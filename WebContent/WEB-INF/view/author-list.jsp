             ...
             <c:forEach var="author" items="${authorList }">
                    ...
                    <tr class="text-center">
                      ...
                      <td class="text-center">
                        <img src="${author.image }" style="max-width: 80px;">
                      </td>
                      <td class="text-center">
                        <div class="btn-group">
                        
                        <a href="form-author-enable?username=${author.username }" class="btn btn-info">
                            <c:if test="${author.enabled }">
                          ...
                          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#delete-modal-${author.username }">
					     ...
					     <div class="modal fade" id="delete-modal-${author.username }">
					      <div class="modal-dialog">
					        <div class="modal-content">
					          ...
					          <div class="modal-footer justify-content-between">
					            ...
					            <a href="form-author-delete?username=${author.username }" class="btn btn-danger">Delete</a>
					          </div>
					        </div>
					        <!-- /.modal-content -->
					      </div>
