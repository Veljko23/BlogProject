                  ...
                  <c:forEach var="message" items="${messageList }">
                    <tr>
                      ...
                      <c:if test="${!message.isSeen}">
                    	<a href="message-seen?id=${message.id }" class="btn btn-block bg-gradient-primary">Mark as seen</a>
                      </c:if>
					      ...
					      <div class="modal-dialog">
					        <div class="modal-content">
					          ...
					          <div class="modal-footer justify-content-between">
					            ...
					            <a href="form-message-delete?id=${message.id }" class="btn btn-danger">Delete</a>
